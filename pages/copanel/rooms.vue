        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">مدیریت اتاق‌های جلسه</h1>
                        <p class="text-gray-600 mt-1">مدیریت و تنظیم اتاق‌های قابل رزرو</p>
                    </div>
                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="room in paginatedRooms" :key="room.pk_room"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <div
                                            class="h-10 w-10 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center text-white font-bold text-sm">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div class="mr-4">
                                        ...
                                        <div class="text-sm text-gray-500">ظرفیت: {{ room.capacity }} نفر</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <div>حداکثر {{ room.maxhoursperweek }} ساعت در هفته</div>
                                <div class="text-gray-500 text-xs">{{ room.max_hours_per_user }} ساعت برای هر کاربر
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <div v-if="room.amountperhour">{{ room.amountperhour.toLocaleString() }} تومان</div>
