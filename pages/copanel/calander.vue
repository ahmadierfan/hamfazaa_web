    ...
    <div class="p-6">
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div v-else class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div
                    class="mb-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4 animate-fade-in">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div class="flex items-center space-x-3 space-x-reverse">
                            ...
                            <div>
                                <h3 class="text-sm font-medium text-blue-900">نحوه رزرو اتاق</h3>
                                <p class="text-xs text-blue-700 mt-1">
                                    <span class="hidden sm:inline">برای رزرو: پس از انتخاب کاربر روی روز مورد نظر کلیک
                                        کرده و به سمت پایین
                                        بکشید</span>
                                    <span class="sm:hidden">برای رزرو: روی روز مورد نظر در تقویم کلیک کنید</span>
                                </p>
                            </div>
                        </div>
                        <button @click="showReservationGuide = true"
                            class="text-blue-600 hover:text-blue-800 transition-colors p-1 rounded-lg hover:bg-blue-100">
